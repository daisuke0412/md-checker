"""
eval_logger.py — checker の LLM 入出力トレース
...
ファイルは期間（日次）単位の追記型 JSON Lines: logs/checker/llm_io_YYYYMMDD.jsonl
"""
...
from ...config import config  # 出力先（CHECKER_LLM_LOG_DIR）は設定の集約点から参照
